...
const pilots = ['development', 'playground'].includes(config.public.appEnv)
    ...
    ? [
        ...
        {
            id: 'eduwallet_pilot_deelnemer_rug_phd',
            institute: 'RUG',
            pilot: 'eduWallet Pilot deelnemer RUG PhD',
            url: '',
        },
        {
            id: 'eduwallet_pilot_deelnemer_rug_edubadges',
            institute: 'RUG',
            pilot: 'eduWallet Pilot deelnemer RUG eduBadges',
            url: '',
        },
        {
            id: 'eduwallet_pilot_deelnemer_rug_diploma_supplement',
            institute: 'RUG',
            pilot: 'eduWallet Pilot deelnemer RUG Diploma Supplement',
            url: '',
        },
        {
            id: 'eduwallet_pilot_deelnemer_hva_diploma_supplement',
            institute: 'HvA',
        ...
        {
            id: 'eduwallet_pilot_deelnemer_kw1c_zorgprofessionals',
            institute: 'KW1C',
