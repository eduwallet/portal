<template>
    <nav class="navigation">
        ...
        <div class="navigation__container-right">
            <LanguageDropdown />
            <PortalAccount v-if="loggedIn" class="navigation__account" />
            <div v-if="!loggedIn">
                <UButton
    ...
    >
        ...
        >
            ...
            <PortalAccount class="navigation__account--mobile" />
            <div
                v-for="item in menu || []"
                :key="item.href"
...
const { logo: maybeLogo, appName, menu } = useAppConfig();
const localePath = useLocalePath();
const { currentProvider, login, loggedIn } = useOidcAuth();
